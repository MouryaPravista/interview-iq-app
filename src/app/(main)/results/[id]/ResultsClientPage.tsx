...
const PerformanceBar = ({ label, score }: { label: string; score: number }) => ( <div> <div className="flex justify-between mb-1"><span className="text-base font-medium text-gray-300">{label}</span><span className="text-sm font-medium text-white">{Math.round(score)}%</span></div> <div className="w-full bg-gray-700 rounded-full h-2.5"><div className="bg-blue-500 h-2.5 rounded-full" style={{ width: `${Math.round(score)}%` }}></div></div> </div> );
const ResultsSkeleton = () => ( <div className="space-y-8"> <SkeletonLoader className="h-9 w-1/3 rounded-md" /> <div className="grid grid-cols-1 lg:grid-cols-3 gap-8"> <div className="lg:col-span-1 bg-gray-800 p-6 rounded-lg flex flex-col items-center justify-center border border-gray-700"> <SkeletonLoader className="h-6 w-2/3 mb-4 rounded-md" /> <SkeletonLoader className="h-40 w-40 rounded-full" /> <SkeletonLoader className="h-4 w-full mt-4 rounded-md" /> <SkeletonLoader className="h-4 w-3/4 mt-2 rounded-md" /> </div> <div className="lg:col-span-2 bg-gray-800 p-6 rounded-lg border border-gray-700"> <SkeletonLoader className="h-8 w-1/2 mb-6 rounded-md" /> <div className="space-y-6"> <SkeletonLoader className="h-6 w-full rounded-md" /> <SkeletonLoader className="h-6 w-full rounded-md" /> <SkeletonLoader className="h-6 w-full rounded-md" /> </div> </div> </div> <div className="bg-gray-800 rounded-lg border border-gray-700"> <div className="p-6"> <SkeletonLoader className="h-8 w-1/4 rounded-md" /> </div> <div className="space-y-4 p-6 border-t border-gray-700"> <SkeletonLoader className="h-24 w-full rounded-md" /> <SkeletonLoader className="h-24 w-full rounded-md" /> </div> </div> </div> );
